...
with({
    ...
    var loadingCommentsBuffer = 20; // increase buffer if loading comments takes long and the loop breaks too soon
    ...
    loadingCommentsBuffer = 20; // increase buffer if loading comments takes long and the loop breaks too soon
    while (loadingCommentsBuffer > 0) {
